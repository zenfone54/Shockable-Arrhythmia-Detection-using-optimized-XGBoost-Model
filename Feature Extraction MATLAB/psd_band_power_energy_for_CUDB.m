...
base_output_path = "D:\Capstone\MatLab\Final codes\CUDB\psd_band_power_energy\";
...
for file_num = 1:35
    ...
    output_filename = sprintf('band_power_energy_cu%02d.csv', file_num);
    ...
    fclose(fileID);
    dlmwrite(full_output_path, [band_power_array_new', energy_array'], '-append', 'precision', '%.4f', 'delimiter', ',');
end
