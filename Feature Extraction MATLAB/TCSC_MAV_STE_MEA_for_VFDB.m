...
base_output_path = "D:\Capstone\MatLab\Final codes\VFDB\TCSC_STE_MAV_MEA\";
...
for file_num = 418:439
    ...
    for i = 1:num_segments
        ...
        % tci_array(i) = mean(diff(crossings) / fs); % Average TCI
    ...
    output_filename = sprintf('TCSC_MAV_STE_MEA_vf%02d.csv', file_num);
