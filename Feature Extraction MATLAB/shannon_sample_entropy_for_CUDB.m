...
base_output_path = "D:\Capstone\MatLab\Final codes\CUDB\shannon_sample_entropy\"; 

% Loop through inputs cu01m.mat to cu35m.mat
...
for file_num = 1:35
    ...
    output_filename = sprintf('shannon_sample_entropy_m-15_r-0-2cu%02d.csv', file_num);
